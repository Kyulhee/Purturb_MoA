...
| RQ | 합성 데이터 | 실제 데이터 (Norman 2019) |
|----|------------|--------------------------|
| RQ1 (불변성) | 통과 (0.50 -> 0.97) | 다세포유형 데이터 필요 |
| RQ2 (조합성) | 유전자공간 통과 (R2=0.88) | 통과 (corr=0.955, R2=0.881) |
| RQ3 (전이) | 통과 (0.51 -> 0.96) | 다세포유형 데이터 필요 |

### 핵심 발견

1. **ICM은 불변성/전이에 확실히 유효** — MMD 정규화가 z_tx 교세포 정렬에 강력
...
| run_06 | 2026-04-27 | Norman 실제데이터 소거실험 | 진행 중 |
