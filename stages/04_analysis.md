...
1. ~~**RQ1/RQ3 실제데이터 검증**~~: run_07 완료 — Replogle K562+RPE1 (843 공유 교란)에서 ICM 효과 확인. RQ1 corr -0.35→0.35, RQ3 R2 -0.30→0.92
...
5. **RQ1 절대값 향상**: 실제데이터 RQ1 corr=0.35 (합성은 0.97). icm_weight/에포크 튜닝으로 개선 가능성
...
- **run_07** (2026-04-27): 다세포유형 실제데이터 검증 (Replogle K562+RPE1, 843 공유 교란) — RQ1 corr -0.35→0.35, RQ3 R2 -0.30→0.92
