...
| 교훈 | 출처 | 유형 | 반영 |
|------|------|------|------|
| 지표 선택이 결론 변경 | run_12 | same | RQ의 직접적 동기 |
| 경쟁자 조기 확인 | FCR-ICM | prior | Framing에서 5개 부분 경쟁자 확인 |
| 잠재공간-유전자공간 갭 | run_05 | prior | 모든 지표 유전자 공간에서 계산 |
| 소거실험 필수 | run_09 | prior | S1-S7 민감도 매트릭스 |
| AUROC=1.0 동어반복 | run_09 | prior | Kendall τ(순위 상관)로 순환 방지 |
