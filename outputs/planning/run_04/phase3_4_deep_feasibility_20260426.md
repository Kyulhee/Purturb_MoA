...
#### 실측 병렬 FBA 벤치마크 (에이전트 실행 결과, 2026-04-26)

E.coli core 모델, GLPK, Windows 11, 16코어 Intel:

| 조합 수 | 순차 (s) | 4-proc (s) | 8-proc (s) | 4-proc Speedup | 8-proc Speedup |
|---------|---------|-----------|-----------|---------------|---------------|
| 100 | 25.4 | 5.0 | 4.5 | 5.1x | 5.7x |
| 500 | 124.2 | 15.8 | 11.2 | 7.9x | 11.1x |
| 1000 | 279.4 | 29.2 | 20.8 | 9.6x | 13.4x |

**핵심 발견**:
- **4-프로세스가 최적 비용 효율**: 87-98% 효율성
- **8-프로세스는 수확 체감**: 62-69% 효율성 (Windows spawn 오버헤드)
- **조합 수 증가 시 병렬화 효율 향상**: 프로세스 생성 오버헤드가 상대적으로 감소
- **1,000 조합 실측**: 순차 ~4.7분, 4-proc ~29초, 8-proc ~21초

상세 리포트: `outputs/planning/run_03/fba_benchmark_report_20260426.md`
...
**방법론적 기여 가능성**: NSGA-II를 dFBA 모델링된 미생물 군집의 접종 비율 최적화에 적용한 문헌 사례가 확인되지 않음. 본 프로젝트의 Phase 4는 새로운 방법론적 기여가 될 가능성이 있음.
